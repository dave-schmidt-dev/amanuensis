...
_FACTORIES: list[ArgvFactory] = [
    ...
    # Phase 2a M7: map sub-app verbs (T7.12).
    lambda ws: ["map", "--workspace", str(ws), "--non-interactive"],
    lambda ws: ["map", "status", "--workspace", str(ws)],
    lambda ws: ["map", "entity", "list", "--workspace", str(ws)],
    lambda ws: ["map", "entity", "show", "e-x", "--workspace", str(ws)],
    lambda ws: [
        "map",
        "entity",
        "merge",
    ...
    lambda ws: ["map", "resolution", "show", "j-x", "--workspace", str(ws)],
    lambda ws: [
        "map",
        "resolution",
        "supersede",
    ...
    # Phase 2c M9: map probandum / probandum-edge / walton-scheme verbs (T9.9).
    lambda ws: [
        "map",
        "probandum",
        "add",
    ...
    lambda ws: ["map", "probandum", "list", "--workspace", str(ws)],
    lambda ws: ["map", "probandum", "show", "p-any", "--workspace", str(ws)],
    lambda ws: ["map", "probandum", "lineage", "p-any", "--workspace", str(ws)],
    lambda ws: [
        "map",
        "probandum",
        "link",
    ...
    lambda ws: ["map", "walton-scheme", "show", "--workspace", str(ws)],
    lambda ws: ["map", "walton-scheme", "snapshot", "--workspace", str(ws)],
]
